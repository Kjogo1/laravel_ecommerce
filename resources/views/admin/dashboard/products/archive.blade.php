                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        <tr
                            ...
                            <th scope="row"
                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white flex flex-wrap items-center">
                                <img src="{{asset('storage/products/'.$product->image)}}" class="mr-2 w-10 rounded-sm">
                                {{$product->name}}
                            </th>
                            <td class="px-6 py-4">
